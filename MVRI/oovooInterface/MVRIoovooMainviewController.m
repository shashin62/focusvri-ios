...
static NSString *kDefaultParticipantInfo = @"";

@interface MVRIoovooMainviewController () <UITextFieldDelegate>
...
@implementation MVRIoovooMainviewController
